...
**Status (2026-09-25):** canon sync against the 2026-09 keystone CV — `llms.txt` and the profile README now state "367 public tests" directly; the "CV summarizes it as 270 unit tests" bridge is dropped (the keystone CV says 367). command-code-mods count pinned to seven per the repo README's mod table and install verification; the keystone CV's old cmd-mods/six-mods wording was updated to match. Dated entries below keep prior wording as history.
